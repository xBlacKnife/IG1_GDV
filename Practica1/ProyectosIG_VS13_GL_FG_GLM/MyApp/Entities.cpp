...
RectangleTex::RectangleTex(GLint x, GLint y, GLdouble l): Entity(x, y)
{
	mesh = Mesh::generateRectangleTex(l);
...
CuboTex::CuboTex(GLint x, GLint y, GLdouble l): Entity(x, y)
{
	mesh = Mesh::generateCuboTex(l);
	mesh2 = Mesh::generateRectangleTex(l);
	texture.load("..\\Bmps\\Zelda.bmp");
}
